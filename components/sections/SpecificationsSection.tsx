  ...
  export function SpecificationsSection() {
            ...
            <div className="grid  lg:grid-cols-2 grid-cols-1 gap-4 lg:gap-20 xl:gap-0">
              ...
              <div className="text-black">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-lg md:text-lg font-medium mb-1">Total Park Land</p>
                    <p className="text-lg md:text-3xl text-[#173c65] font-bold">57 ha</p>
                    <p className="text-sm text-muted-foreground mt-1">Phase 1: 33 ha</p>
                  </div>
                </div>
              </div>
            </div>
   <div className="space-y-8 ">
              ...
              <div className="pt-4">
                ...
                <div>
                  <p className="text-lg font-medium mb-1">For Sale or BTS Projects</p>
            ...
            <div className="space-y-8 ">
              <div>
                ...
                <ul className="space-y-3 text-sm md:text-base leading-relaxed">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-muted-foreground mt-1">•</span>
                    <span>Fully equipped dock doors (up to 1 dock / 350 SQM approx.)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-muted-foreground mt-1">•</span>
